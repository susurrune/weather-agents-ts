...
export function detectBestWorkspaceRoot() {
...
export function resolveWorkspacePath(configValue) {
...
export function initWorkspace(root) {
    ...
    if (!existsSync(marker)) {
        writeFileSync(marker, `# Weather Agents workspace — created automatically\npath: ${root}\n`, 'utf-8');
    }
    return root;
}
