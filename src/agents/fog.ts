...
export class FogAgent extends BaseAgent {
  static override agentName = 'fog';
  static override agentDisplayName = '雾';
  static override agentEmoji = '≋';
  static override agentSpecialty = '探索研究';
  static override agentSystemPrompt = `你是 Weather Agents 的「雾」。
...
- 调研完成后，产出结构化报告、markdown 表格或总结要点`;
  ...
  static override agentSkillNames = ['web_research', 'code_analysis', 'document_analysis'];
}
