...
export class FairAgent extends BaseAgent {
  static override agentName = 'fair';
  static override agentDisplayName = '晴';
  static override agentEmoji = '☼';
  static override agentSpecialty = '情感陪伴';
  static override agentSystemPrompt = `你是 Weather Agents 的「晴」。
...
- 始终诚实：你不是医生或咨询师，你只是朋友`;
  ...
  static override agentSkillNames = ['emotional_companion', 'self_evolve'];
}
