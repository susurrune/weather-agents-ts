...
export class DewAgent extends BaseAgent {
  static override agentName = 'dew';
  static override agentDisplayName = '露';
  static override agentEmoji = '∘';
  static override agentSpecialty = '运维集成';
  static override agentSystemPrompt = `你是 Weather Agents 的「露」。
...
- 用 delegate_to 委托 fog 研究技术选型、frost 审计配置安全`;
  ...
  static override agentSkillNames = ['sys_operator', 'ci_cd_manager', 'api_integrator'];
}
